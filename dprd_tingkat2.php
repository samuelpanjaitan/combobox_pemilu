...
<p align="center">DPRD - Kabupaten / Kota<br>(Perolehan Suara Per Dapil di Kabupaten / Kota)<br><br>Masukkan Data</p>

		<form action="tambah_data.php" method="post">
			<table border="0" align="center"  width="center">
				<tr>
				...
				<tr>
					<td width="200px">Daerah Pemilihan (Dapil)</td>
					<td>:</td>
				...
				<tr>
					<td width="200px">Kelurahan / Desa</td>
					<td>:</td>
				...
				<tr>
					<td width="200px">Jumlah Suara</td>
					<td>:</td>
		...
		<hr>
		<p align="center">Partai <br>DPRD - Kabupaten / Kota<br>(Perolehan Suara Per Dapil di Kabupaten / Kota)</p>
		<table border="1" align="center" style="margin-top: 20px" width="700px">
			...
			<tr align="center">
				...
				<td width="250px">Dapil</td>
				<td width="250px">Kabupaten / Kota</td>
				<td width="250px">Kecamatan / Distrik</td>
				<td width="350px">Kelurahan / Desa</td>
				<td width="150px">TPS</td>
				<td width="100px">Jumlah Suara</td>
			</tr>
